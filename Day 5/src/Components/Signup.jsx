    ...
    <div className="signup-background">
        <div className="signup-container">       
            <form onSubmit={(handleSubmit)}>
                ...
                <input className="common-input-field" type="text" placeholder="Address" name="loction" onChange={(handleOnChange)}/>
                <button className="common-button">Create User</button>
